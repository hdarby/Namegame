...
public class Person implements Parcelable {
    ...
    private final ArrayList<SocialLinks> socialLinks;
    ...
    private Person(Parcel in) {
        ...
        this.socialLinks = in.readParcelable(SocialLinks.class.getClassLoader());
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeArray(this.socialLinks.toArray());
    }
